...
Commit message conventions are defined in https://github.com/kieranpotts/standards/tree/main/ts/003/[TS-3: Version Control]. Commit messages are expected to follow this format:
